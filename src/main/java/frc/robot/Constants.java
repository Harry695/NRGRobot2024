...
public final class Constants {
  ...
  public static class RobotConstants {
    ...
    public static final double APRILTAG_CAMERA_PITCH = Math.toRadians(-15);
  ...
  public static class ColorConstants {
    ...
    public static final Color8Bit COLORS[] = { BLACK, WHITE, RED, ORANGE, YELLOW, GREEN, BLUE, LIGHTBLUE, PURPLE,
        PINK };

  }

  public static class FieldConstants {
    public static final Pose3d BLUE_SPEAKER_TOP = new Pose3d(); //TODO: get constants 
    public static final Pose3d RED_SPEAKER_TOP = new Pose3d(); //TODO: get constants 
  }
}
